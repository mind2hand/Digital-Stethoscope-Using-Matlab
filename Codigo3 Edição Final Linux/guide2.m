...
%GUIDE2 MATLAB code file for guide2.fig
...
%
%      GUIDE2('Property','Value',...) creates a new GUIDE2 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to guide2_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      GUIDE2('CALLBACK') and GUIDE2('CALLBACK',hObject,...) call the
%      local function named CALLBACK in GUIDE2.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 27-Dec-2018 18:01:41
...
% Hint: get(hObject,'Value') returns toggle state of parar
...
% --- Executes on selection change in res.
function res_Callback(hObject, eventdata, handles)
% hObject    handle to res (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns res contents as cell array
%        contents{get(hObject,'Value')} returns selected item from res
...
% hObject    handle to edit_prop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --------------------------------------------------------------------
function audio_prop_Callback(hObject, eventdata, handles)
% hObject    handle to audio_prop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --------------------------------------------------------------------
function filter_prop_Callback(hObject, eventdata, handles)
% hObject    handle to filter_prop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --------------------------------------------------------------------
function amp_prop_Callback(hObject, eventdata, handles)
% hObject    handle to amp_prop (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on selection change in resy.
function resy_Callback(hObject, eventdata, handles)
% hObject    handle to resy (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns resy contents as cell array
%        contents{get(hObject,'Value')} returns selected item from resy
...
% --- Executes on button press in resy_auto.
function resy_auto_Callback(hObject, eventdata, handles)
% hObject    handle to resy_auto (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of resy_auto
