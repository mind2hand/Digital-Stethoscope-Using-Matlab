Heart_Sounds_Analyzer Executable
...
-run_Heart_Sounds_Analyzer.sh (shell script for temporarily setting environment variables 
   ...
   -to run the shell script, type
    ...
    run the shell script as:
       ...
       ./run_Heart_Sounds_Analyzer.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v94/runtime/glnxa64:MR/v94/bin/glnxa64:MR/v94/sys/os/glnxa64:MR/v94/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_Heart_Sounds_Analyzer.sh 
